                        ...
                        <div class="card col-md-5 text-white bg-primary py-5">
                            <div class="card-body text-center">
                                <div>
                                    ...
                                    <a href="#login-card" class="btn btn-light text-primary login " default='hidden' onclick="document.getElementById('register-card').style.display = 'none' , document.getElementById('login-card').style.display='block'" aria-selected="true," aria-controls="login-card">login</a>
                                    <a href="#register-card" class="btn btn-light text-primary register" default='block' onclick="document.getElementById('login-card').style.display = 'none', document.getElementById('register-card').style.display='block'" aria-controls="register-card">register</a>
                                </div>
                            </div>
                        </div>
                    </div>
